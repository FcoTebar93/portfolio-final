...
function updatePageContent() {
  ...
  const translationsMap: Record<string, string> = {
    ...
    'experience.roles.freelance': t('experience.roles.freelance'),
    ...
    'experience.locations.freelance': t('experience.locations.freelance'),
    'experience.locations.aunoa': t('experience.locations.aunoa'),
    'experience.locations.mimacom': t('experience.locations.mimacom'),
    'experience.descriptions.freelance': t('experience.descriptions.freelance'),
    ...
    'projects.items.mentorix.name': t('projects.items.mentorix.name'),
    'projects.items.mentorix.role': t('projects.items.mentorix.role'),
    'projects.items.mentorix.short': t('projects.items.mentorix.short'),
    'projects.items.mentorix.long': t('projects.items.mentorix.long'),
